...
def get_args_parser():
    ...
    parser.add_argument('--pretrained_weights', default=None, type=str,
        help="""Path to pretrained backbone weights used to initialize continued pre-training.
        This only initializes model weights and does not restore optimizer, loss, or epoch state.""")
    parser.add_argument('--pretrained_checkpoint_key', default='teacher', type=str,
        help="""Key to use in --pretrained_weights. Examples: teacher, student, state_dict, model.
        Set to an empty string to load the checkpoint root directly.""")
...
def train_ibot(args):
    ...
    if args.pretrained_weights:
        checkpoint_key = args.pretrained_checkpoint_key if args.pretrained_checkpoint_key else None
        print("Initializing student backbone from pretrained weights: {} (key: {})".format(
            args.pretrained_weights, checkpoint_key))
